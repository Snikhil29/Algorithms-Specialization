...
def process(filename):
    clauses, literalCount = os.read(filename)
...
process("S://Algorithms//c3//2sat1.txt")
process("S://Algorithms//c3//2sat2.txt")
process("S://Algorithms//c3//2sat3.txt")
process("S://Algorithms//c3//2sat4.txt")
process("S://Algorithms//c3//2sat5.txt")
process("S://Algorithms//c3//2sat6.txt")
